                  ...
                  <div className="flex flex-wrap items-center">
                    ...
                    <div className="mb-5 flex items-center">
                      <p className="text-body-color mr-5 flex items-center text-base font-medium">
                        ...
                        Última actualización {publishDate}
                      </p>
                    </div>
                  </div>
                  <div className="mb-5">
                ...
                <div>
                  ...
                  <ul className="text-body-color mb-10 list-inside list-disc">
                    {leaning.map((learn) => (
                      <li
                        key={learn}
                        className="text-body-color mb-2 text-base font-medium sm:text-lg lg:text-base xl:text-lg"
                      >
                        {learn}
                      </li>
                    ))}
                  ...
                  <div className="bg-primary/10 relative z-10 mb-10 overflow-hidden rounded-md p-8 md:p-9 lg:p-8 xl:p-9">
                    <p className="text-body-color text-center text-base font-medium italic">
                      Modalidad 100% online, con acceso a videos, materiales
                      descargables y ejercicios guiados que podrás realizar a tu
                      propio ritmo.
                    </p>
                  ...
                  <div className="items-center justify-between sm:flex">
                    <div className="mb-5">
                      ...
                      <div className="flex items-center">
                        <TagButton text="Musica" />
                        <TagButton text="Composición" />
