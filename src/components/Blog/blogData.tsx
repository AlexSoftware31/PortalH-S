...
const blogData: Blog[] = [
  ...
  },
  {
    ...
    videoLinks: {
      basico: [
        "https://www.youtube.com/watch?v=CV48WSGDzD0",
        "https://www.youtube.com/watch?v=q7JsAB5c6wM",
        "https://www.youtube.com/watch?v=0KSva41Uw5o",
      ],
      intermedio: [
        "https://www.youtube.com/watch?v=5fsvABv_b44",
        "https://www.youtube.com/watch?v=hIUWxy-VLeU",
      ],
      avanzado: [
        "https://www.youtube.com/watch?v=xnoAaWKYt7w",
        "https://www.youtube.com/watch?v=Du2Uke83Uzc",
      ],
    },
  },
  {
    ...
    image: "/images/blog/teoria-musical.jpg",
    author: {
      name: "Luisa Carderon",
    ...
    publishDate: "11/2025",
    description:
      "El curso está diseñado para que desarrolles una base sólida en teoría musical, comprendas cómo funciona la música que escuchas y tocas, y te sientas preparado para avanzar hacia la composición, la interpretación o el análisis musical.",
    leaning: [
      "Lectura de notas en clave de sol y fa.",
      "Figuras rítmicas, compases y subdivisiones.",
      "Escalas mayores, menores y modos básicos",
      "Formación de acordes y progresiones armónicas.",
      "Introducción al análisis musical y formas compositivas.",
      "Ejercicios auditivos para reconocer intervalos y ritmos",
    ],
    videoLinks: {
      basico: [
        "https://www.youtube.com/watch?v=3tE78JZ_6Lg",
        "https://www.youtube.com/watch?v=gEIXGCJGMUQ",
        "https://www.youtube.com/watch?v=uLJ7TDJPQUY",
      ],
      intermedio: [
        "https://www.youtube.com/watch?v=CrKPPkPnpr0",
        "https://www.youtube.com/watch?v=D9ssBjkYuEE",
      ],
      avanzado: ["https://www.youtube.com/watch?v=gV_FJrNUv90"],
    },
  },
  {
    id: 6,
    ...
    image: "/images/blog/canto-tecnica.jpg",
    author: {
      name: "Juan Sanz",
      image: "/images/blog/author-03.png",
      designation: "Musico",
